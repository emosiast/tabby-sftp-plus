...
entirely in the plugin and reuses your existing SSH session.
...
Built on top of [Tabby](https://github.com/Eugeny/tabby) by Eugeny — a fantastic,
extensible terminal. This fork adds the SFTP+ experience on top of it.

Licensed under the **MIT License** (same as upstream Tabby).
